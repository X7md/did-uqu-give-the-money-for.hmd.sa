// DGA «كود المنصات» button, re-implemented shadcn-style.
// Mirrors .dga-btn: inline-flex, radius-sm (4px), no border, 2px focus outline.
...
const variants: Record<Variant, string> = {
  ...
  subtle: 'bg-transparent text-primary hover:bg-primary-light disabled:text-muted-foreground',
  danger:
